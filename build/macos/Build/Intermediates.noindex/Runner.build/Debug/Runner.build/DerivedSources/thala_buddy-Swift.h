...
#ifndef THALA_BUDDY_SWIFT_H
#define THALA_BUDDY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="thala_buddy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11thala_buddy11AppDelegate")
...
SWIFT_CLASS("_TtC11thala_buddy17MainFlutterWindow")
